#############################################################################
# Makefile for building: voting-system.app/Contents/MacOS/voting-system
# Generated by qmake (3.1) (Qt 6.9.3)
# Project:  voting-system.pro
# Template: app
# Command: /opt/homebrew/opt/qt/bin/qmake -o Makefile voting-system.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = voting-system1.0.0
DISTDIR = /Users/ankityadav/Desktop/voting-system/.tmp/voting-system1.0.0
...
LIBS          = $(SUBLIBS) -F/opt/homebrew/lib -framework QtGui -framework AppKit -framework ImageIO -framework Metal -framework QtCore -framework IOKit -framework DiskArbitration -framework UniformTypeIdentifiers -framework OpenGL   
...
DIST          = /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		...
		voting-system.pro  gui.cpp \
		main.cpp
QMAKE_TARGET  = voting-system
DESTDIR       = 
TARGET        = voting-system.app/Contents/MacOS/voting-system

####### Custom Variables
EXPORT_QMAKE_MAC_SDK = macosx
EXPORT_QMAKE_MAC_SDK_VERSION = 26.0
EXPORT_QMAKE_XCODE_DEVELOPER_PATH = /Library/Developer/CommandLineTools
EXPORT__QMAKE_STASH_ = /Users/ankityadav/Desktop/voting-system/.qmake.stash
...
EXPORT__PRO_FILE_ = /Users/ankityadav/Desktop/voting-system/voting-system.pro
...
voting-system.app/Contents/MacOS/voting-system:  $(OBJECTS)  
	@test -d voting-system.app/Contents/MacOS/ || mkdir -p voting-system.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: voting-system.pro /opt/homebrew/share/qt/mkspecs/macx-clang/qmake.conf /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		/opt/homebrew/share/qt/mkspecs/features/device_config.prf \
		/opt/homebrew/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/share/qt/mkspecs/common/macx.conf \
	...
	$(QMAKE) -o Makefile voting-system.pro
...
voting-system.app/Contents/PkgInfo: 
	@test -d voting-system.app/Contents || mkdir -p voting-system.app/Contents
	@$(DEL_FILE) voting-system.app/Contents/PkgInfo
	@echo "APPL????" > voting-system.app/Contents/PkgInfo
voting-system.app/Contents/Info.plist: 
	@test -d voting-system.app/Contents || mkdir -p voting-system.app/Contents
	@$(DEL_FILE) voting-system.app/Contents/Info.plist
	@set -o pipefail && plutil -convert xml1 -o - /opt/homebrew/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,com.yourcompany.voting-system,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},com.yourcompany.voting-system,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},14.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,voting-system,g" -e "s,@LIBRARY@,voting-system,g" -e "s,\$${EXECUTABLE_NAME},voting-system,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >voting-system.app/Contents/Info.plist

all: Makefile \
		voting-system.app/Contents/PkgInfo \
		voting-system.app/Contents/Info.plist voting-system.app/Contents/MacOS/voting-system
...
distdir: FORCE
	...
	$(COPY_FILE) --parents gui.cpp main.cpp $(DISTDIR)/
...
gui.moc: gui.cpp \
	...
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include /Users/ankityadav/Desktop/voting-system/moc_predefs.h -I/opt/homebrew/share/qt/mkspecs/macx-clang -I/Users/ankityadav/Desktop/voting-system -I/Users/ankityadav/Desktop/voting-system -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/c++/v1 -I/Library/Developer/CommandLineTools/usr/lib/clang/17/include -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include -I/Library/Developer/CommandLineTools/usr/include -F/opt/homebrew/lib gui.cpp -o gui.moc
